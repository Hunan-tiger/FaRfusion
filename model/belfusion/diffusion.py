...
class GaussianDiffusion:
    ...
    def __init__(
        ...
        **kwargs
        ...
        assert loss_type in loss_type_dict.keys(), f"losses='{loss_type}' not supported"
        self.loss_type = loss_type_dict[loss_type]
...
class LatentDiffusion(GaussianDiffusion):
    ...
    def __init__(self, cfg):
        ...
        self.loss_coef=cfg.get("loss_coef", 1.0)
    ...
    def test_(
        ...
        shape = (batch_size, seq_len, matcher.get_emb_size()) # [b, emb_size]
        ...
        if noise is not None:
            ...
            img = th.randn(*shape, device=device) * self.noise_std
        indices = list(range(self.num_timesteps))[::-1]  #倒序 [9, 8, 7, 6..., 1, 0]
    ...
    def train_(self, model, x_start, t, model_kwargs=None, k_active=False, noise=None, all_kwargs=None):
